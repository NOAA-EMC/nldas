...
/* AUTHOR: Greg O'Donnell [tempgd@hydro.washington.edu]
   ...
   10/23/07     - added a flag for the NARR bias corrected retrospective forcings
                which hides the original code from the JGR 1996-1999 retro and 
                realtime runs which had blended EDAS and obs precip and dswrf 
                                                                        JS
...
int main( int argc, char *argv[])
{
  ...
  */
#if NARR_RETRO
  /* variables available from NLDAS phase 2, the NARR bias corrected retrospective forcings */
  char met_attr[MET_VAR_MAX][MET_ATTR_MAX][BUFSIZ+1] = { 
        {"1", "NARR temp",              "TMP_",         "84",   "11",   "1",    "213.0",        "333.0"},       /* NARR 2m air temp [k] */
        {"1", "NARR spf humidity",      "SPFH_",        "84",   "51",   "1",    "0.0000001",    "0.03"},        /* NARR specific humidity [kg/
kg] */
        {"1", "NARR pressure",          "PRES_",        "84",   "1",    "1",    "5000.0",       "110000.0"},    /* NARR surface pressure [mb] 
*/
        {"1", "NARR wind u",            "UGRD_",        "84",   "33",   "1",    "-75.0",        "75.0"},        /* NARR wind u [m/s] */
        {"1", "NARR wind v",            "VGRD_",        "84",   "34",   "1",    "-75.0",        "75.0"},        /* NARR wind v [m/s] */
        {"1", "NARR longwave",          "DLWRF_",       "84",   "205",  "1",    "75.0",         "750.0"},       /* NARR downward longwave [w/m
2] */
        {"0", "NARR rain/snow flag",    "var153_",      "84",   "153",  "1",    "0.0",          "1.0"},         /* NARR rain snow flag [-] */
        {"0", "NARR cape",              "CAPE_",        "84",   "157",  "1",    "MISSING",      "MISSING"},     /* NARR con. avail. pot. energ
y [] */
        {"0", "NARR pevap",             "PEVAP_",       "84",   "228",  "1",    "MISSING",      "MISSING"},     /* NARR potential evaporation 
[] */
        {"1", "CPC PRISM total prec",	"APCP_",        "84",  "61",   "0",    "0.0",          "140.0"},       /* CPC PRISM total precip [mm] */
        {"1", "Goes adjust. sw", 	"DSWRF_",       "84",  "204",  "1",    "0.0",          "1372.0"}       /* goes adjust. downward short
wave [w/m2] */
  };
#else
  /* variables from the original NLDAS phase 1, 1996-1999 retrospective runs */
  char met_attr[MET_VAR_MAX][MET_ATTR_MAX][BUFSIZ+1] = { 
	{"1", "Edas temp", 			"TMP_",		"84",	"11",	"1",	"213.0",		"333.0"},	/* edas 2m air temp [k] */
	{"1", "Edas spf humidity", 	"SPFH_",	"84",	"51",	"1",	"0.0000001",	"0.03"},	/* edas specific humidity [kg/kg] */
	{"1", "Edas pressure", 		"PRES_",	"84",	"1",	"1",	"5000.0",		"110000.0"},/* edas surface pressure [mb] */
	{"1", "Edas wind u", 		"UGRD_",	"84",	"33",	"1",	"-75.0",		"75.0"},	/* edas wind u [m/s] */
	{"1", "Edas wind v", 		"VGRD_",	"84",	"34",	"1",	"-75.0",		"75.0"},	/* edas wind v [m/s] */
	{"1", "Edas shortwave", 	"DSWRF1_",	"84",	"204",	"1",	"0.0",			"1372.0"},	/* edas downward shortwave [w/m2] */
	{"1", "Edas longwave", 		"DLWRF_",	"84",	"205",	"1",	"75.0",			"750.0"},	/* edas downward longwave [w/m2] */
	{"1", "Edas total precip", 	"APCP1_",	"84",	"61",	"0",	"0.0",			"140.0"},	/* edas total precip [kg/m2] */
	{"1", "Edas conv precip", 	"ACPCP_",	"84",	"63",	"0",	"0.0",			"140.0"},	/* edas convective precip [kg/m2] */
	{"0", "Edas Cape", 			"CAPE_",	"84",	"157",	"1",	"MISSING",		"MISSING"},	/* edas conv. avail. pot. energy */
	{"1", "Goes shortwave", 	"DSWRF_",	"154",	"204",	"1",	"0.0",			"1372.0"},	/* goes downward shortwave [w/m2] */
	{"0", "Goes bright temp", 	"BRTMP_",	"154",	"118",	"1",	"-99999",		"99999"},	/* goes skin temp [K] */
	{"0", "Diffuse radiation", 	"HTSGW_",	"154",	"100",	"1",	"MISSING",		"MISSING"},	/* diffuse radiation */
	{"0", "Par", 				"WVDIR_",	"154",	"101",	"1",	"MISSING",		"MISSING"},	/* par */
  ...
  for(i=0; i<global_param.nrecs; i++){
...
#if NARR_RETRO
            /* convert from instantaneous to ave */
    ...
    /* free up array */
    if(grib_data != (float *)NULL) { free(grib_data); grib_data = NULL; }  
    if(grib_data_old != (float *)NULL) { free(grib_data_old); grib_data_old = NULL; }  
