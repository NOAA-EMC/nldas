...
!EOP
      REAL(CPP_REAL), ALLOCATABLE, SAVE :: InStatic(:), OutStatic(:)
...
! !INPUT PARAMETERS:
      ...
      REAL(CPP_REAL), INTENT( IN )  :: Input( * )  ! Input Array
! !OUTPUT PARAMETERS:
      REAL(CPP_REAL), INTENT( OUT ) :: Output( * ) ! Output Array
!
! !DESCRIPTION:
!
...
! !LOCAL VARIABLES:
      ...
      REAL(CPP_REAL), ALLOCATABLE :: InBuf(:), OutBuf(:)
