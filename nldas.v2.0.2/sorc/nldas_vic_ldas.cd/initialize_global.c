...
static char vcid[] = "$Id: initialize_global.c,v 4.1 2000/05/16 21:07:16 vicadmin Exp $";
...
/*********************************************************************
  ...
  Modifications:
  09/12/00	options.ARC_SOIL initialised to FALSE.				
  												JS
  												
  09/12/00	upper limit of j when intialising param_set.FORCE_INDEX[i][j]
  		set to N_FORCING_TYPES. Previously it was hard-coded
  		as 17 which can cause problems with over-writing memory
  		if N_FORCING_TYPES is not 17.
