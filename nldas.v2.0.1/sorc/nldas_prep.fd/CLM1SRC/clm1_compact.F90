...
!=========================================================================
! $Id: clm1_compact.F90,v 1.1.1.1 2003/02/06 16:10:46 jgottsch Exp $
!=========================================================================

  use precision
  use clm1type
  use clm1_varcon, only : denice, denh2o, tfrz
  implicit none
...
!=== End Variable List ===================================================
  ...
  do i = clm1%snl+1, 0
     ...
     wx = clm1%h2osoi_ice(i) + clm1%h2osoi_liq(i)
     void=1.-(clm1%h2osoi_ice(i)/denice+clm1%h2osoi_liq(i)/denh2o)/clm1%dz(i)

! Disallow compaction for water saturated node and lower ice lens node.

     if(void <= 0.001 .or. clm1%h2osoi_ice(i) <= .1)then
        burden = burden+wx
        cycle
     endif

     bi = clm1%h2osoi_ice(i) / clm1%dz(i)
     fi = clm1%h2osoi_ice(i) / wx
     td = tfrz-clm1%t_soisno(i)
     dexpf = exp(-c4*td)
...
! Liquid water term
     ...
     if(clm1%h2osoi_liq(i) > 0.01*clm1%dz(i)) ddz1=ddz1*c5
...
! Compaction occurring during melt
     ...
     if(clm1%imelt(i) == 1)then
        ddz3 = - 1./clm1%dtime * max(0.,(clm1%frac_iceold(i) - fi)/clm1%frac_iceold(i))
     else
        ddz3 = 0.
     endif
...
! The change in dz due to compaction
     ...
     clm1%dz(i) = clm1%dz(i)*(1.+pdzdtc*clm1%dtime)
