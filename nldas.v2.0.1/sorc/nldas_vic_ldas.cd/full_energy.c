...
static char vcid[] = "$Id: full_energy.c,v 4.1 2000/05/16 21:07:16 vicadmin Exp $";
...
/**********************************************************************
  ...
  09-15-00	initialsed roughness to zero so that when there is no 
  		vegetation (bare soil only) it has a valid value.	JS
