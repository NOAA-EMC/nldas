...
subroutine clm1_qsadv (T,       p,       es,       &
                      esdT,    qs,      qsdT      )

!=========================================================================
!
!  clm1CLMCLMCLMCLMCLMCLMCLMCL  A community developed and sponsored, freely   
...
!=========================================================================
! $Id: clm1_qsadv.F90,v 1.1.1.1 2003/02/06 16:10:45 jgottsch Exp $
!=========================================================================
...
!=== End Variable List ===================================================
  ...
  T_limit = T
  if (T_limit > 373.15) T_limit=373.15
  if (T_limit < 198.15) T_limit=198.15
