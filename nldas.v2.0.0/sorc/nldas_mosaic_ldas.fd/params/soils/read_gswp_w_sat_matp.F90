...
!BOP
!
! !ROUTINE: read\_gswp\_w\_sat\_matp
!
! !DESCRIPTION:
...
!EOP      
  ...
  call lis_log_msg('MSG: read_gswp_w_sat_matp -- '//  &
                   'Reading GSWP w_sat_matp file: '// &
                   trim(lis%p%w_sat_matp_file))

  status = nf90_open(path=lis%p%w_sat_matp_file, mode=nf90_nowrite, ncid=ncid)
  status = nf90_inq_varid(ncid, "W_sat_matp", varid)
...
end subroutine read_gswp_w_sat_matp
