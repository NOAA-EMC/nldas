...
! 
!-----------------------------------------------------------------------
! $Id: inicFileMod.F90,v 1.7 2004/11/24 23:24:17 jim Exp $
!-----------------------------------------------------------------------
...
! --------------------------------------------------------------------
    print*,'type_inidat not supposed to be called..'
#if 0 
    if (masterproc) then
...
! Open netCDF data file and read data and check input dimensions
    print*,'histrd not supposed to be called..'
#if 0 
    if (masterproc) then
       call getfil (finidat, locfn, 0)
       call wrap_open (locfn, nf_nowrite, ncid)
...
! Open netCDF data file and read data
    print*,'inicrd not supposed to be called..'
#if 0 
    if (masterproc) then
...
! --------------------------------------------------------------------
    print*,'inicwrt not supposed to be called..'
#if 0 
    if (masterproc) then
...
! define global attributes
       ...
       str = '$Id: inicFileMod.F90,v 1.7 2004/11/24 23:24:17 jim Exp $'
...
! -----------------------------------------------------------------
    ...
    print*,'do inicwrite not supposed to be called..'
    do_inicwrite = .false.
#if 0 
