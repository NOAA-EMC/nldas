...
/* Justin Sheffield: gcc v3.4.4 complains about type conversion on IA64, so 
explicitly set prototype for memchr to return a (char *) and not the standard
(void *) */
...
*/
          if (!strncmp((fwa_msg + lMessageSize - 4L),"7777",4))
		/*  && fwa_msg[7]==1)  */
	  {  
