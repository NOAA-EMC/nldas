...
*/
  ...
  /* latitude & lon of 1st grid point */
   pGDS_Lam_Input->lLat1 = (long) (geom_in.first_lat *1000.); 
   pGDS_Lam_Input->lLon1 = (long) ((geom_in.first_lon) *1000.); 
   pGDS_Lam_Input->usRes_flag = geom_in.usRes_flag;/*Resolution flags Tbl7*/
   pGDS_Lam_Input->lLon_orient=(long)(geom_in.parm_3 *1000.);/*grid orient */
   pGDS_Lam_Input->ulDx=(unsigned long)(geom_in.x_int_dis*1000.);/*Xdir gridlen*/
   pGDS_Lam_Input->ulDy=(unsigned long)(geom_in.y_int_dis*1000.);/*Ydir gridlen*/
  ...
  /*  Make sure CUT1 is closest to Pole  */
   ...
   pGDS_Lam_Input->lLat_cut1=(long)(cut1 *1000.);/* 1stlat fr pole secant cuts*/
   pGDS_Lam_Input->lLat_cut2=(long)(cut2 *1000.);/* 2ndlat fr pole secant cuts*/
...
*/
   ...
   pGDS_PS_Input->lLat1 = (long)(geom_in.first_lat *1000.);/*lat of 1st gridpt*/
   pGDS_PS_Input->lLon1 = (long)(geom_in.first_lon *1000.);/*lon of 1st gridpt*/
   pGDS_PS_Input->usRes_flag = geom_in.usRes_flag;/* resolution flags Tbl7 */
   pGDS_PS_Input->lLon_orient = (long)(geom_in.parm_2 *1000.);/*grid orient*/
   pGDS_PS_Input->ulDx=(unsigned long)(geom_in.x_int_dis*1000.);/*Xdir gridlen*/
   pGDS_PS_Input->ulDy=(unsigned long)(geom_in.y_int_dis*1000.);/*Ydir gridlen*/
   if ((geom_in.y_int_dis != 0) && (geom_in.x_int_dis != 0))
...
*/
   ...
   pGDS_Latlon_Input->lLat1=(long)(geom_in.first_lat*1000.);/*lat of 1stgridpt*/
   pGDS_Latlon_Input->lLon1=(long)(geom_in.first_lon*1000.);/*lon of 1stgridpt*/
   pGDS_Latlon_Input->usRes_flag=geom_in.usRes_flag;/*resolution flags Tbl7*/
   pGDS_Latlon_Input->lLat2 =(long)(geom_in.last_lat*1000.);/*lat of 2ndgridpt*/
   pGDS_Latlon_Input->lLon2 =(long)(geom_in.last_lon*1000.);/*lon of 2ndgridpt*/
   pGDS_Latlon_Input->iDi = (int) (geom_in.parm_2 *1000.);/* i-dir incr*/
   pGDS_Latlon_Input->iDj = (int) (geom_in.parm_1 *1000.);/* j-dir incr*/
...
/* convert lStretch to 4 chars */
      memcpy ((void *) pLatlon->achStretch, (void*)&Inp->lStretch, 4 );
