...
/* assigns the values from USER_INPUT to PDS_Input */
   ...
   pPDS_Input->usLevel_id = Data_Input.usLevel_id; /* Type of level/layer-Tbl3*/ /* Height, pressure of level 1  and 2 */ pPDS_Input->usHeight1 =(unsigned short)Data_Input.nLvl_1 ; pPDS_Input->usHeight2 =(unsigned short)Data_Input.nLvl_2 ; pPDS_Input->usYear =(unsigned short)( Data_Input.nYear % 100 ); /* Year */
...
*/
      ...
      switch(pPDS_Input->usLevel_id){
		...
		(void *)&(pPDS_Input->usHeight1), 2);
          break;

        default:
          tpds->achHeight[0]= pPDS_Input->usHeight1 & 0x000F;
          tpds->achHeight[1]= pPDS_Input->usHeight2 & 0x000F;
          break;
      }
      ...
      memcpy((void *)tpds->achTime_range_avg, 
		(void *)&(pPDS_Input->usTime_range_avg), 2);
      ...
      memcpy((void *)tpds->achDec_sc_fctr, (void *)&sDec_sc_fctr, 2);
      ...
      lTemp= ulPDS_length << 8;
      memcpy ((void *) tpds->achPDS_length, (void *)&lTemp, 3 );
