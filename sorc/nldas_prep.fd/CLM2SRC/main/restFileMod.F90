...
! 
!-----------------------------------------------------------------------
! $Id: restFileMod.F90,v 1.1.1.1 2003/02/06 16:10:50 jgottsch Exp $
!-----------------------------------------------------------------------
...
!!    set_restart_filename = "./"//trim(caseid)//".clm2.r."//trim(cdate)
     ...
     fdir = "mkdir -p "//" ./OUTPUT/EXP"//trim(caseid)//"/CLM2/"//trim(cyear)//"/"//trim(cnhdate)
     call system(trim(fdir))
     
     set_restart_filename = "./OUTPUT/EXP"//trim(caseid)//"/CLM2/"//trim(cyear)//"/"//trim(cnhdate) &
           //"/LDAS.E"//trim(caseid)//"."//trim(cdate)//".CLM2rst"
