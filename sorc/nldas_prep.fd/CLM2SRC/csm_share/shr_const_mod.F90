!===============================================================================
! CVS $Id: shr_const_mod.F90,v 1.1.1.1 2003/02/06 16:10:55 jgottsch Exp $
! CVS $Source: /YUKON/LDASCVS/LDAS/SRC/CLM2SRC/csm_share/shr_const_mod.F90,v $
! CVS $Name:  $
!===============================================================================
...
!   real(SHR_KIND_R8),parameter :: SHR_CONST_TKREF = 273.16_SHR_KIND_R8       ! conversion of K to C
!   real(SHR_KIND_R8),parameter :: SHR_CONST_ZZSICE = 0.0005_SHR_KIND_R8      ! ice surface roughness
!   real(SHR_KIND_R8),parameter :: SHR_CONST_RHOA  = SHR_CONST_RHODAIR
!   real(SHR_KIND_R8),parameter :: SHR_CONST_RHOW  = SHR_CONST_RHOFW
!   real(SHR_KIND_R8),parameter :: SHR_CONST_RHOI  = SHR_CONST_RHOICE
!   real(SHR_KIND_R8),parameter :: SHR_CONST_CPW   = SHR_CONST_CPFW
!   real(SHR_KIND_R8),parameter :: SHR_CONST_CPAIR = SHR_CONST_CPDAIR
!   real(SHR_KIND_R8),parameter :: SHR_CONST_CPA   = SHR_CONST_CPDAIR
!   real(SHR_KIND_R8),parameter :: SHR_CONST_CW    = 0.6524_SHR_KIND_R8
!   real(SHR_KIND_R8),parameter :: SHR_CONST_TFRZ  = SHR_CONST_TKFRZ
