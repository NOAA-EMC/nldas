...
!=========================================================================
  ...
  SUBROUTINE MOSLAIREAD (LDAS,MOS,TILE,YR1,MO1,YR2,MO2,TIME1,TIME2, &
                         WT1,WT2)
 ...
 92  format(a4,a2)
  ...
  CASE(2)
   CALL AVHRR_G_FILE(NAME9,NAME10,NAME11,NAME12,NAME13,NAME14, &
                     NAME15,NAME16,LDAS%AVHRRDIR,CYR1,CYR2,CMO1,CMO2)
  CASE(3)  
   CALL MODIS_G_FILE(NAME9,NAME10,NAME11,NAME12,NAME13,NAME14, &
                     NAME15,NAME16,LDAS%MODISDIR,CYR1,CYR2,CMO1,CMO2)
  CASE DEFAULT
...
!=== Set parameters to read 1/8 LAI/DSAI data
     ...
     MLAT = (TILE(T)%LAT - (-59.9375)) / 0.125 + 1
     MLON = (TILE(T)%LON - (-179.9375)) / 0.125 + 1
