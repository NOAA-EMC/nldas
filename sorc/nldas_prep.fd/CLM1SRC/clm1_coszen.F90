...
subroutine clm1_coszen (clm1, day, coszen)
...
!=========================================================================
! $Id: clm1_coszen.F90,v 1.1.1.1 2003/02/06 16:10:45 jgottsch Exp $
!=========================================================================
...
!=== Arguments ===========================================================
  ...
  type (clm11d), intent(inout)  :: clm1    !clm1 1-D Module
...
! to slightly above horizon, as discussed in description.
  ...
  coszen = sin(clm1%lat)*sind &
         + cos(clm1%lat)*cosd*cos(hrang)

  if (coszen >= -0.001 .and. coszen <= 0.) coszen=0.001

end subroutine clm1_coszen
