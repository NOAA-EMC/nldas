...
! 
!-----------------------------------------------------------------------
! $Id: clm1_varcon.F90,v 1.1.1.1 2003/02/06 16:10:47 jgottsch Exp $
!-----------------------------------------------------------------------

  use precision
  use clm1_varpar, only : numcol, numrad
  implicit none
...
!------------------------------------------------------------------
  ...
  real(r8) :: denh2o = 1000.     !density of liquid water [kg/m3]
