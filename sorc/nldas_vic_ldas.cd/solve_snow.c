...
static char vcid[] = "$Id: solve_snow.c,v 4.1 2000/05/16 21:07:16 vicadmin Exp $";
...
/*********************************************************************
  ...
  10-10-00 store the snowmelt in the snow structure.			JS
...
/** Start of changes -- JS **/
          /* test for very small snowfall as this may cause instabilities in the energy balance calculations */
          if(snowfall[WET] < 1e-5) snowfall[WET] = 0.;
/** Start of changes -- JS **/
