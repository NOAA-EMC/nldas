...
static char vcid[] = "$Id: write_atmosdata.c,v 4.1 2000/05/16 21:07:16 vicadmin Exp $";
...
/**********************************************************************
  ...
  Modifications:
  	092500	Removed line to close debug output files as the files
  		are written to again with data for the next cell
  													JS
**********************************************************************/
{
#if LINK_DEBUG
