...
static char vcid[] = "$Id: read_soilparam.c,v 4.1 2000/05/16 21:07:16 vicadmin Exp $";
...
/** Start of changes -- JS **/
/* rint fails on Linux Alpha compiler */
/*    temp.depth[layer] = rint(temp.depth[layer] * 1000) / 1000;*/
    temp.depth[layer] = (double)((temp.depth[layer] * 1000) / 1000);
/** End of changes -- JS **/
