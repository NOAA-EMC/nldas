...
! 
!-----------------------------------------------------------------------
! $Id: mvegFileMod.F90,v 1.6 2004/11/24 22:57:19 jim Exp $
!-----------------------------------------------------------------------
...
! ----------------------------------------------------------------------
    print*, 'not supposed to be in read monthly veg..'
#if 0 
    if (masterproc) then
...
! patches first and then setting non-vegetated patches to zero
       ...
       open(78,file="laitestout",status='unknown',form='unformatted')
       write(78) testlai1
