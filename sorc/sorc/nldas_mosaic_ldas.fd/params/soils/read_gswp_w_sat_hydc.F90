...
!BOP
!
! !ROUTINE: read\_gswp\_w\_sat\_hydc
!
! !DESCRIPTION:
...
!EOP      
  ...
  call lis_log_msg('MSG: read_gswp_w_sat_hydc -- '//  &
                   'Reading GSWP w_sat_hydc file: '// &
                   trim(lis%p%w_sat_hydc_file))

  status = nf90_open(path=lis%p%w_sat_hydc_file, mode=nf90_nowrite, ncid=ncid)
  status = nf90_inq_varid(ncid, "W_sat_hydc", varid)
...
end subroutine read_gswp_w_sat_hydc
