...
!EOP      
  ...
  call lis_open_file(15,file=lis%p%iscfile,form='unformatted',status='old',&
                     access='direct',recl=4, script='getcolor.pl')
#if ( defined OPENDAP )
     line = 1
     do r=1,lis_nr_data
        do c=1,lis_nc_data
  ...
  print*, 'MSG: read color file'

!EOC
end subroutine read_color
