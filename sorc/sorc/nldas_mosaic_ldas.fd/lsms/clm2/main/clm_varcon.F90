...
! omega,betad,betai for snow 
  ...
  integer :: iyear_AD ! to simulate above earth's orbital parameters for
  logical :: doalb
  real(r8) :: eccen   ! Earth's eccentricity factor
  real(r8) :: obliq   ! Earth's obliquity angle
  real(r8) :: mvelpp   ! Earth's moving vernal equinoz at perhelion
