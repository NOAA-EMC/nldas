...
!
! \subsection{Core Functions of time$_-$interp$_-$nldas}
!  \begin{description}
!  \item[zterp]  
...
#if(defined SPMD)
  call MPI_BCAST(nldasdrv%nldastime1,1,MPI_REAL8,0, & 
       MPI_COMM_WORLD,ier)
  call MPI_BCAST(nldasdrv%nldastime2,1,MPI_REAL8,0, & 
       MPI_COMM_WORLD,ier)
...
!=== Interpolate Data in time      
   wt1=(nldasdrv%nldastime2-lis%t%time)/ & 
        (nldasdrv%nldastime2-nldasdrv%nldastime1)
   wt2=1.0-wt1
