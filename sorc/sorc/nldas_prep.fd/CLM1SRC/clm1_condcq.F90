...
subroutine clm1_condcq (raw,        rbw,      rdw,               &   
                       rpp,        wtaq,     wtlq,              &
                       wtgq,       wtaq0,    wtlq0,    wtgq0,   &
                       wtalq,      wtgaq,    wtglq,     clm1     )
...
!=== End Variable List ===================================================
  ...
  wtaq  = clm1%frac_veg_nosno/raw                                ! air
  wtlq  = clm1%frac_veg_nosno*(clm1%elai+clm1%esai)/rbw * rpp      ! leaf
  wtgq  = clm1%frac_veg_nosno/rdw                                ! ground
