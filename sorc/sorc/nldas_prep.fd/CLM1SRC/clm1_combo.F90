...
subroutine clm1_combo (dz,     wliq,     wice,     t,            &
                      dz2,    wliq2,    wice2,    t2            ) 
...
!=========================================================================
! $Id: clm1_combo.F90,v 1.1.1.1 2003/02/06 16:10:43 jgottsch Exp $
!=========================================================================

  use precision
  use clm1_varcon,  only : cpice, cpliq, tfrz, hfus         
  implicit none
