...
!
!-----------------------------------------------------------------------
! $Id: Biogeophysics1.F90,v 1.1.1.1 2003/02/06 16:10:59 jgottsch Exp $
!-----------------------------------------------------------------------
...
!
  ...
  call QSatclm(clm%tg, clm%forc_pbot, eg, degdT, qsatg, &
            qsatgdT)
...
!=== canopy heights and cause model crash 
  ...
  clm%forc_hgt_t=10.0+clm%displa+clm%z0m
  clm%forc_hgt_q=10.0+clm%displa+clm%z0m
