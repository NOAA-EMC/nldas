...
! 
!-----------------------------------------------------------------------
! $Id: inicFileMod.F90,v 1.1.1.1 2003/02/06 16:10:51 jgottsch Exp $
!-----------------------------------------------------------------------
  ...
  use clm_varmap  , only : landvec, patchvec, numpatch, begland, endland
...
! define global attributes
       ...
       str = '$Id: inicFileMod.F90,v 1.1.1.1 2003/02/06 16:10:51 jgottsch Exp $'
